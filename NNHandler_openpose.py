...
class NNHandler_openpose(NNHandler):
	...
	# POSE_PAIRS = [(0, 1), (1, 8), (1, 2), (2, 3), (3, 4), (1, 5), (5, 6), (6, 7), (8, 9), (9, 10), (10, 11), (8, 12), (12, 13), (13, 14)]
	THRESH = .2


	@staticmethod
	def plot(img, points):
		points = {i:(points[3*i], points[3*i+1], points[3*i+2]) for i in range(len(points)//3)}
	...
	def __init__(self, openpose_dir=None, openpose_file=None, is_tracked=False):
		...
		print("Creating a Openpose handler")
